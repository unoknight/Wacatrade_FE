...
<template>
  ...
  >
    <div class="hidden sidebar-header">
        ...
        <vs-tabs alignment="fixed" class="sidebar_tab">
          ...
          >
            <div class="con-tab-ejemplo">
              ...
              <div v-else class="flex flex-col justify-center mt-5 mb-20">
                <div :key="indextr" v-for="(oknha, indextr) in listItemOpen">
                  <p
                    v-if="$store.state.accountType === oknha.acc_type"
                    class="mt-3 mb-3 font-16 color-gray"
                  >
                    {{ fromatTimzoneD(oknha.time) }}
                  </p>
                  <div
                    v-if="$store.state.accountType === oknha.acc_type"
                    class="mb-2 transactionBox"
                  >
                    <div class="flex justify-between mb-2">
                      <span class="font-bold text-white">
                        <span v-if="!oknha.acc_type" class="text-xs accType"
                          >DEMO</span
                        >
                      </span>
                ...
                <div :key="indextr" v-for="(oknha, indextr) in listItem">
                  ...
                  >
                    <div class="flex justify-between mb-2">
                      <span class="font-bold text-white"
                        >{{ oknha.c }}
                        <span v-if="!oknha.t" class="text-xs accType"
                          >DEMO</span
                        >
                      </span>
                      <span class="icon iconBitcoin"></span>
