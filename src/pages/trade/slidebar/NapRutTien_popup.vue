...
<template>
    ...
    <div class="deposit_widthdraw ">
        <div class="headerTab">
            <ul class="pl-0 mb-0 listTab">
                <li class="itemTab" :class="{active: activeNRT = getSetSys.isDepositOpen}" @click="activeNRT = true, getSetSys.isWithdraOpen = false, getSetSys.isDepositOpen = true"><span>{{ $t("Deposit")}}</span>
                </li>
                <li class="itemTab" :class="{active: getSetSys.isWithdraOpen}" @click="activeNRT = false, getSetSys.isDepositOpen = false, getSetSys.isWithdraOpen = true"><span>{{ $t("Withdraw")}}</span>
                </li>
            </ul>
        </div>
                            ...
                            <div class="boxSelectUnit bgSecondary3 borderSecondary2 cbx" :class="{activeSelectItem: showSelectTypeC}" @click="showSelectTypeC ? showSelectTypeC = false : showSelectTypeC = true">
                                <div id="selectedUnitDeposit" :class="`selectedUnit hasitem ${textTypePay}`">
                                    ...
                                    <div class="info">
                                        ...
                                        <i class="absolute right-0 material-icons" style="top: 5px;">expand_more</i>
                                    </div>
                                </div>
                                <div class="shadow listUnits">
                                    <div class="itemSelectUnit PAYPAL" @click="selectTypePay('PAYPAL')" v-if="getSetSys.isActiveWalletPaypal">
                                        <div class="icon PAYPAL"></div>
                                        <div class="info">
                                            <div class="w-full amount">
                                    ...
                                    <div class="itemSelectUnit VND" @click="selectTypePay('VND')" v-if="getSetSys.isActiveWalletVND">
                                        ...
                                        <div class="info">
                                            <div class="w-full amount">
                                                <span class="number">{{ activeNRT ? $t('DepositShort') : $t('WithdrawShort')}} {{ $t("MoneyVND")}}</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="boxAddress">
                        <div v-if="isPaypal">
                            <div class="transfer-network">
                                <div v-if="!activeNRT">
                                    <h4 class="mt-0 transfer-network-title">
                                        {{ $t("Network")}}
                                    </h4>
                                    <ul class="transfer-network-list transfer-network-list--deposit has-bsc">
                                        <li class="transfer-network-item" :class="{'is-active': isActiveSelectTransPaypal}" @click="isActiveSelectTransPaypal = true">
                                            ...
                                            <span class="transfer-network-item-fee">{{ $t("Tax")}} {{ getSetSys.feeRutPaypalNoiBo }} USD</span>
                                        </li>
                                        <li class="transfer-network-item" :class="{'is-active': !isActiveSelectTransPaypal}" @click="isActiveSelectTransPaypal = false">
                                            ...
                                            <span class="transfer-network-item-fee">{{ $t("Tax")}} {{ getSetSys.feeRutPaypalAcc }} USD</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="deposit_widthdraw_box">
                                    <div class="relative mt-4 form-group">
                                    ...
                                    <div class="relative form-group" v-if="!activeNRT">
                                    ...
                                    <div class="text-center address">
                                        <div class="p-4 text-center" v-if="isNap">
                                        ...
                                        <vs-button v-if="activeNRT" class="buttonCommon greenButton" :class="{hidden: isNap}" type="filled" @click="DepositPaypal">{{ $t("Deposit")}}</vs-button>
                        ...
                        <div v-if="isVND" :class="isMobile ? 'scrollMobile' : ''">
                           <div class="deposit_widthdraw_box" v-if="activeNRT">
                                ...
                                <div v-else class="text-center address">
                                    ...
                                    <vs-button class="buttonCommon greenButton" :class="{hidden: isNap}" type="filled" @click="DepositVND()">{{ $t("Deposit")}}</vs-button>
                                </div>
                            </div>
                            ...
                            <div v-else class="deposit_widthdraw_box">
                                ...
                                <div class="relative form-group">
                                    <vs-select v-model="tenNganHang" label="Tên ngân hàng *" class="w-full mt-5" name="item-category" placeholder="Chọn ngân hàng">
                                ...
                                <div v-else-if="!DISABLE_2FA">
                                    <div class="relative form-group">
                                        ...
                                        <div class="mt-4 text-center address">
                        ...
                        <div v-else>
                            <div class="transfer-network">
								...
								<ul class="transfer-network-list transfer-network-list--deposit has-bsc">
									<li class="transfer-network-item" :class="{'is-active': isActiveSelectTransNB}" @click="isActiveSelectTransNB = true, isActiveSelectTransBEP20 = false, isActiveSelectTransERC20 = false">
										<span class="transfer-network-item-label">{{ !activeNRT ? '{{ $t("Internal")}}' : 'BEP20 (BSC)' }}</span>
										<span class="transfer-network-item-fee" v-if="!activeNRT">{{ $t("Tax")}} {{ getSetSys.feeRutUSDTNoiBo }} USDT</span>
									</li>
                                    <li v-if="!activeNRT" class="transfer-network-item transfer-network-item--bsc" :class="{'is-active': isActiveSelectTransBEP20}" @click="isActiveSelectTransBEP20 = true, isActiveSelectTransNB = false, isActiveSelectTransERC20 = false">
										...
										<span class="transfer-network-item-fee" v-if="!activeNRT">{{ $t("Tax")}} {{ getSetSys.feeRutUSDTBEP20 }} USDT</span>
									</li>
									<!--<li v-if="!activeNRT" class="transfer-network-item" :class="{'is-active': isActiveSelectTransERC20}" @click="isActiveSelectTransERC20 = true, isActiveSelectTransNB = false, isActiveSelectTransBEP20 = false">
										...
										<span class="transfer-network-item-fee" v-if="!activeNRT">{{ $t("Tax")}} {{ getSetSys.feeRutUSDTERC20 }} USDT</span>
									</li>-->
								</ul>
								<p class="transfer-network-warn" v-if="activeNRT" :class="{'hidden': !isActiveSelectTransNB}">
									<span class="font-bold">{{ $t("Lucky_Becarefull")}}</span> {{ $t("Attention_txt")}}
								</p>
                            ...
                            <div class="depos" :class="{block: activeNRT}">
                                <h4 class="text-center">{{ $t("Address_txt")}}</h4>
                                ...
                                <div>
                                    <div class="md:w-full">
                                        ...
                                        <div class="text-center md:w-full">
                                            <div class="address">
                                                <span class="noted">{{ $t("Attention_deposit")}} {{ getSetSys.minDepositUSDT }} USDT</span>
                                                ...
                                                <vs-button class="buttonCommon greenButton" type="filled" @click="CopyAddress">{{ $t("Clipboard")}}</vs-button>
                            ...
                            <div class="depos deposit_widthdraw_box" :class="{block: !activeNRT}">
                                <div class="relative form-group">
                                    ...
                                    <input type="number" v-model="amount" decimal="true" :placeholder="this.$t('Min_withdraw')` ${ activeNRT ? getSetSys.minDepositUSDT : getSetSys.minWithdrawalUSDT } USDT`" class="form-control">
                                    <button class="btn sendMax button primary" @click="enterMaxAmount">{{ $t("Max")}}</button>
                                </div>
                                <div class="relative form-group">
                                    <h4 class="colorSecondary2">{{ isActiveSelectTransNB ? $t('ID_user_withdraw') : $t('Address_withdraw') }} </h4>
                                    <input type="text" v-model="adddressWithDrawal" :placeholder="`${ isActiveSelectTransNB ? $t('Input_ID_user_withdraw') : $t('Input_Address_withdraw') }`" class="form-control "/>

                                </div>
                                <div class="relative form-group">
                                    <h4 class="colorSecondary2"> {{ $t("Balance_Tab1_TableColumn5")}} <i>({{ $t("NotRequire")}})</i> </h4>
                                    <input type="text" v-model="noteRut" :aria-placeholder="$t('Withdraw_note')" class="form-control ">
                                </div>
                                <div v-if="DISABLE_2FA">
                                    <div class="text-center address">
                                        <vs-button class="buttonCommon redButton" type="filled" @click="Withdrawal()">{{ $t("Withdraw")}}</vs-button>
                                    </div>
                                </div>
                                <div v-else>
                                    <div v-if="!pop2FAokPay">
                                        <div class="text-center address">
                                            <small class="colorRed enable2fa" v-if="!getData.c2fa">{{ $t("Must2FA")}}</small>
                                            <vs-button :disabled="!getData.c2fa" class="buttonCommon redButton" type="filled" @click="Withdrawal()">{{ $t("Withdraw")}}</vs-button>
                                        </div>
                                    </div>
                                    <div v-else>
                                        <div class="relative form-group">
                                            <h4 class="colorSecondary2"><i>{{ $t("txt2FA_withdraw")}} *</i> </h4>
                                            <input type="text" v-model="code2FA" :placeholder="this.$t('txt2FA_withdraw')" class="form-control ">
                                            <div class="mt-4 text-center address">
                                                <vs-button class="buttonCommon redButton" type="filled" @click="WithdrawalOKPay()">{{ $t("Agree")}}</vs-button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    methods: {
        ...
        DepositVND(){
            if(this.amount < getSetSys.minDepositUSDT){
                return this.$vs.notify({
                    text: this.$t('MustDeposit')` $${getSetSys.minDepositUSDT}.`,
                    iconPack: 'feather',
                    icon: 'icon-check',
                    position:'top-right',
                    color: 'danger'
        ...
        DepositPaypal(){
            if(this.amount < getSetSys.minDepositPaypal){
                return this.$vs.notify({
                    text: this.$t('MustDeposit')` $${getSetSys.minDepositPaypal}.`,
                    iconPack: 'feather',
                    icon: 'icon-check',
                    position:'top-right',
                    color: 'danger'
        ...
        WithDrawalPaypal(){
            ...
            if(amount < getSetSys.maxWithdrawalUSDT){
              return this.$vs.notify({
                      text: this.$t('MustDeposit')` $${getSetSys.maxWithdrawalUSDT}.`,
                      color:'danger',
                      position:'top-right',
                      iconPack: 'feather',
                      icon:'icon-x-circle'
        ...
        Withdrawal(){
            ...
            if(amount < getSetSys.minWithdrawalUSDT){
              return this.$vs.notify({
                      text: this.$t('MustDeposit')` $${getSetSys.minWithdrawalUSDT}.`,
                      color:'danger',
                      position:'top-right',
                      iconPack: 'feather',
                      icon:'icon-x-circle'
