              ...
              >
                ...
                >
                  ...
                  <div class="info">
                    ...
                    <i class="absolute right-0 material-icons" style="top: 5px"
                      >expand_more</i
                    >
                  </div>
                </div>
                <div class="shadow listUnits">
                  ...
                  >
                    ...
                    <div class="info">
                      <div class="w-full amount">
                        <span class="number"
                          >{{ activeNRT ? $t('DepositShort') : $t('WithdrawShort') }} {{ $t("MoneyVND")}}</span
                        >
                      </div>
                    </div>
                  </div>
          ...
          <div class="boxAddress">
            <div v-if="isPaypal">
              <div class="transfer-network">
                <div v-if="!activeNRT">
                  <h4 class="mt-0 transfer-network-title">{{ $t("Network")}}</h4>
                  <ul
                  ...
                  >
                    ...
                    >
                      ...
                      <span class="transfer-network-item-fee"
                        >{{ $t("Tax")}}{{ getSetSys.feeRutPaypalNoiBo }} USD</span
                      >
                    </li>
                    <li
                      class="transfer-network-item"
                    ...
                    >
                      ...
                      <span class="transfer-network-item-fee"
                        >{{ $t("Tax")}}{{ getSetSys.feeRutPaypalAcc }} USD</span
                      >
                    </li>
                  </ul>
                </div>
                <div class="deposit_widthdraw_box">
                  <div class="relative mt-4 form-group">
                    <h4 class="colorSecondary2">{{ $t("ValueUSDT")}}</h4>
                    <input
                      v-if="activeNRT"
                      type="number"
                      v-model="amount"
                      decimal="true"
                      :placeholder="this.$t('Min_withdraw')`: ${getSetSys.minDepositPaypal} USDT`"
                      class="form-control"
                    />
                    <input
                      v-if="!activeNRT"
                      ...
                      v-model="amount"
                      decimal="true"
                      :placeholder="this.$t('Min_withdraw')`: ${getSetSys.minWithdrawalPaypal} USDT`"
                      class="form-control"
                    />
                    <button
            ...
            <div v-if="isVND" :class="isMobile ? 'scrollMobile' : ''">
              ...
              <div v-else class="deposit_widthdraw_box">
                <div class="colorSecondary2">
                  {{ $t("USDWallet")}}
                  <span class="mr-2 price"> {{ getAmount }}$ </span>
                </div>
                <div class="colorSecondary2">
                  {{ $t("AmountMonneyTransfer")}}
                ...
                <div class="relative form-group">
                  <h4 class="colorSecondary2">{{ $t("Bank")}}</h4>
                  <input
                ...
                <div class="relative form-group">
                  <h4 class="colorSecondary2">{{ $t("BankNumber")}}</h4>
                  <input
                    placeholder="Input Your Number Bank"
                    type="text"
                    v-model="soTaiKhoan"
                    class="form-control"
                  />
                ...
                <div class="relative form-group">
                  <h4 class="colorSecondary2">{{ $t("UserBank")}}</h4>
                  <input
                    placeholder="Input owner bank"
                    type="text"
                    v-model="chuTaiKhoan"
                    class="form-control"
                  />
                ...
                <div class="relative form-group">
                  <h4 class="colorSecondary2">
                    {{ $t("F17NapTable_Note")}} <i>({{ $t("NotRequire")}})</i>
                  </h4>
                  <input
                    type="text"
                    v-model="noteRut"
                ...
                >
                  ...
                  >
                    ...
                    <span class="transfer-network-item-fee" v-if="!activeNRT"
                      >{{ $t("Tax")}}{{ getSetSys.feeRutUSDTNoiBo }} USDT</span
                    >
                  </li>
                  <li
                    v-if="!activeNRT"
                  ...
                  >
                    ...
                    <span class="transfer-network-item-fee" v-if="!activeNRT"
                      >{{ $t("Tax")}}{{ getSetSys.feeRutUSDTBEP20 }} USDT</span
                    >
                  </li>
                  ...
                  <div class="md:w-full">
                    <div class="address">
                      <input
                        ...
                        readonly="readonly"
                        id="depositAddress"
                        class="text-center bgSecondary colorSecondary2"
                      />
                    </div>
              ...
              >
                  ...
                  <h4 class="colorSecondary2">
                    {{
                      isActiveSelectTransNB
                        ? this.$t('ID_user_withdraw')
                        : this.$t('Address_withdraw')
                    }}
                  </h4>
                  <input
                    type="text"
                    ...
                    :placeholder="`${
                      isActiveSelectTransNB
                        ? this.$t('Input_ID_user_withdraw')
                        : this.$t('Input_Address_withdraw')
                    }`"
                    class="form-control"
                  />
                </div>
                <div class="relative form-group">
                  ...
                  <input
                    type="text"
                    v-model="noteRut"
                    :placeholder="this.$t('Withdraw_note')"
                    class="form-control"
                  />
                </div>
                  ...
                  <div v-else>
                    <div class="relative form-group">
                      ...
                      <input
                        type="text"
                        v-model="code2FA"
                        :placeholder="this.$t('txt2FA_withdraw')"
                        class="form-control"
                      />
                      <div class="mt-4 text-center address">
                        <vs-button
...
export default {
  ...
  methods: {
    ...
    WithdrawalOKPay() {
      ...
      if(getData.displayName ==  this.adddressWithDrawal)
      {
        return this.$vs.notify({
            text: this.$t('WrongNicknameWithdraw'),
            color: "danger",
            position: "top-right",
            iconPack: "feather",
            icon: "icon-x-circle",
