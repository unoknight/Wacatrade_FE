...
export default [
  ...
  },
  {
    ...
    items: [
      ...
      {
        url: '/account/list-all-account-marketing',
        name: "Tài khoản marketing",
        icon: "UsersIcon",
        slug: "list-all-account-marketing",
        //i18n: "Tất cả",
      },
      {
        url: '/account/list-all-account-deleted',
        name: "Tài khoản đã xóa",
        icon: "UsersIcon",
        slug: "list-all-account-deleted",
        //i18n: "Tất cả",
      },
      {
