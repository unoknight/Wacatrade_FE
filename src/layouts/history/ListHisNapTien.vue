      ...
      <vs-table ref="table" multiple v-model="selectedUser" :data="products">
        <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
          ...
          <div class="flex flex-wrap-reverse items-center data-list-btn-container">
            ...
            <!-- TRASH -->
            <div class="btn-add-new p-3 mb-4 mr-4 rounded-lg cursor-pointer flex items-center justify-center text-lg font-medium text-base text-danger border border-solid border-danger" @click.stop="currentPage = 1; trashDataDeposit()">
...
export default {
  ...
  methods: {
    ...
    trashDataDeposit(){
      ...
      AuthenticationService.getDepositAllTrash(params)
      .then((resp) => {
    ...
    reloadList(){
      ...
      AuthenticationService.getDepositListHistory(params)
      .then((resp) => {
