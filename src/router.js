            ...
            children: [
...

                {
                    ...
                    meta: {
                        ...
                        pageTitle: 'Tài khoản thường',
                        rule: 'editor'
                    },
                },
                {
                    path: '/account/list-all-account-marketing',
                    name: 'list-all-account-marketing',
                    component: () => import('./layouts/account/AccountAllMemberListMKT.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Trang chủ', url: '/' },
                            { title: 'Danh sách tài khoản', active: true },
                        ],
                        pageTitle: 'Tài khoản marketing',
                        rule: 'editor'
                    },
                },
                {
                    path: '/account/list-all-account-deleted',
                    name: 'list-all-account-deleted',
                    component: () => import('./layouts/account/AccountAllMemberListDeleted.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Trang chủ', url: '/' },
                            { title: 'Danh sách tài khoản', active: true },
                ...
                {
                    path: '/account/list-experts',
                    name: 'list-experts',
                    component: () => import('./layouts/account/ExpertsList.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Trang chủ', url: '/' },
                            { title: 'Danh sách chuyên gia', active: true },
                        ],
                        pageTitle: 'Chuyên gia',
                        rule: 'editor'
                    },
                },
