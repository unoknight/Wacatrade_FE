  ...
  <div class="footerFAQs">
    <div class="container position-relative">
      ...
      <div class="ft-1">
        <div class="block">
          <p class="des1">
            {{domain}} is authorised by the {{domain}} TRADING LIMITED and regulated
            under the Judicial Authority of Portugal. {{domain}} TRADING LIMITED
          ...
          <p style="text-align: center" class="des2">
            © {{domain}} 2020 All rights reserved. ‘{{ domain }}’ is a trademark of the
            {{domain}} TRADING LIMITED.
          </p>
        </div>
      </div>
    </div>
