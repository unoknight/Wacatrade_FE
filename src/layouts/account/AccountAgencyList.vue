      ...
      <vs-table ref="table" multiple v-model="selectedUser" pagination :max-items="itemsPerPage" search :data="products">
        ...
        <div slot="header" class="flex flex-wrap-reverse items-center justify-between flex-grow">
          ...
          <div class="flex flex-wrap-reverse items-center data-list-btn-container">
            ...
            <!-- ADD NEW -->
            <div class="flex items-center justify-center p-3 mb-4 mr-4 text-base text-lg font-medium border border-solid rounded-lg cursor-pointer btn-add-new text-primary border-primary" @click="addNewAccount">
          ...
          <template slot-scope="{data}">
            <tbody>
              <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                  ...
                  <vs-td>
                      <p class="font-medium truncate agency-name">{{ tr.email }}</p>
                      <p>
                ...
                <vs-td>
                  <p class="font-medium truncate agency-name">{{ tr.first_name }}<br>Biệt danh: {{ tr.nick_name }}</p>
                </vs-td>

                <vs-td>
                  <p>
                  <IconCrypto style="width: 20px" coinname="USDT" color="color" format="svg" /> ${{ formatPrice(tr.money_usdt, 2) }}
                  </p>
                </vs-td>
